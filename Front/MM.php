...
<body>
    <header>
        <h1>Servicio Mecanico | Disponible</h1>
    </header>
    <div class="trabajos-disponibles">
        <h2>Mecanicos Disponibles</h2>
        <ul>
        <?php
            ...
            $sql = "SELECT * FROM trabajador WHERE Profesion = 'mecanico'";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a class='SolicitarServicio' href='SolicitudServicio.php?tipo_servicio=mecanico&Correo_Cliente={$Correo_Cliente}'>Solicitar Servicio</a>";
                    echo "</div>";
                    echo "</li>";
                }
            } else {
                echo "No se encontraron trabajadores con la profesión 'Mecanico'.";
            }
