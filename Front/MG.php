...
<body>
    <header>
        <h1>Servicio de Gasfiter | Disponible</h1>
    </header>
    <div class="trabajos-disponibles">
        <h2>Gasfiters Disponibles</h2>
        <ul>
        <?php
            ...
            $sql = "SELECT * FROM trabajador WHERE Profesion = 'gasfiter'";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a class='SolicitarServicio' href='SolicitudServicio.php?tipo_servicio=gasfiter&Correo_Cliente={$Correo_Cliente}'>Solicitar Servicio</a>";
                    echo "</div>";
                    echo "</li>";
                }
            } else {
                echo "No se encontraron trabajadores con la profesión 'Gasfiter'.";
            }
