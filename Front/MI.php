...
<head>
    ...
    <title>TecHome® | Informaticos</title>
...
<body>
    <header>
        <h1>Servicio de Informatica | Disponible</h1>
    </header>
    ...
    <div class="trabajos-disponibles">
        ...
        <?php
            ...
            $sql = "SELECT * FROM trabajador WHERE Profesion = 'informatico'";
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<a class='SolicitarServicio' href='SolicitudServicio.php?tipo_servicio=informatico&Correo_Cliente={$Correo_Cliente}'>Solicitar Servicio</a>";
                    echo "</div>";
                    echo "</li>";
                }
            } else {
                echo "No se encontraron trabajadores con la profesión 'Informatico'.";
            }
