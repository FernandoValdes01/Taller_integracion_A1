...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2023 a las 02:18:11
...
(2, 'Instalación de sistema eléctrico en la cocina', '150.00', 1, '2023-10-21', 2, '43434343-4', 'trabajando'),
(3, 'Construcción de mesa de madera para el jardín', '200.00', 3, '2023-10-22', 3, '43434343-4', 'finalizado'),
(4, 'Reparación de motor de automóvil', '120.00', NULL, '2023-10-23', 4, '43434343-4', 'en camino'),
(5, 'Desarrollo de software de gestión de inventario', '180.00', NULL, '2023-10-24', 5, '43434343-4', 'trabajando'),
(6, 'Mantenimiento de jardín delantero', '90.00', NULL, '2023-10-25', 6, '43434343-4', 'finalizado'),
(7, 'Instalación de sistema de gas en la cocina', '160.00', NULL, '2023-10-26', 7, '43434343-4', 'en camino'),
...
(13, 'Diseño de muebles modernos para sala', '210.00', NULL, '2023-11-01', 13, '43434343-4', 'en camino'),
...
(21, 'Instalación de sistema de riego automático', '120.00', NULL, '2023-11-09', 21, NULL, 'finalizado'),
(22, 'Desarrollo de aplicación móvil para comercio', '170.00', NULL, '2023-11-10', 22, '43434343-4', 'en camino'),
...
INSERT INTO `trabajador` (`Rut_trabajador`, `Nombre_Trabajador`, `Correo_Trabajador`, `Profesion`, `Monto_Cuenta`, `contraseña`, `Calificacion_T`, `Pedidos`, `Descripcion`, `Rut_Administrador`) VALUES
('12121212-2', 'Trabajador Ocho', 'trabajador8@example.com', 'carpintero', '21000.00', 'contraseña8', NULL, NULL, 'Experto en construcción de estructuras de madera a medida.', NULL),
('13131313-3', 'Trabajador Nueve', 'trabajador9@example.com', 'mecanico', '18000.00', 'contraseña9', NULL, NULL, 'Amplia experiencia en reparaciones de motores y transmisiones.', NULL),
('14141414-4', 'Trabajador Diez', 'trabajador10@example.com', 'informatico', '16000.00', 'contraseña10', NULL, NULL, 'Especialista en desarrollo de software y soluciones tecnológicas.', NULL),
('15151515-5', 'Trabajador Once', 'trabajador11@example.com', 'gasfiter', '17000.00', 'contraseña11', NULL, NULL, 'Amplia experiencia en instalaciones de sistemas de agua para edificios comerciales.', NULL),
('18181818-8', 'Trabajador Catorce', 'trabajador14@example.com', 'informatico', '15000.00', 'contraseña14', NULL, NULL, 'Experto en administración de sistemas y redes informáticas.', NULL),
('19191919-9', 'Trabajador Quince', 'trabajador15@example.com', 'gasfiter', '18000.00', 'contraseña15', NULL, NULL, 'Especialista en instalaciones de fontanería para proyectos residenciales.', NULL),
('20202020-0', 'Trabajador Dieciséis', 'trabajador16@example.com', 'carpintero', '17500.00', 'contraseña16', NULL, NULL, 'Amplia experiencia en construcción de estructuras de madera para espacios comerciales.', NULL),
('21212121-1', 'Trabajador Diecisiete', 'trabajador17@example.com', 'mecanico', '21000.00', 'contraseña17', NULL, NULL, 'Especialista en reparaciones de motores diesel y maquinaria pesada.', NULL),
('22222222-2', 'Trabajador Dieciocho', 'trabajador18@example.com', 'informatico', '18000.00', '', NULL, NULL, 'Amplia experiencia en desarrollo de aplicaciones y soluciones empresariales.', NULL),
('24242424-4', 'Trabajador Veinte', 'trabajador20@example.com', 'carpintero', '15000.00', 'contraseña20', NULL, NULL, 'Experto en diseño y construcción de mobiliario de madera para oficinas.', NULL),
('27272727-7', 'Trabajador Veintitrés', 'trabajador23@example.com', 'gasfiter', '17500.00', 'contraseña23', NULL, NULL, 'xddchatgpt', NULL),
('28282828-8', 'Trabajador Veinticuatro', 'trabajador24@example.com', 'carpintero', '18000.00', 'contraseña24', NULL, NULL, 'Especialista en restauración de muebles antiguos y diseño de interiores.', NULL),
('29292929-9', 'Trabajador Veinticinco', 'trabajador25@example.com', 'mecanico', '16000.00', 'contraseña25', NULL, NULL, 'Amplia experiencia en reparaciones de motores de vehículos híbridos.', NULL),
('30303030-0', 'Trabajador Veintiséis', 'trabajador26@example.com', 'informatico', '17000.00', 'contraseña26', NULL, NULL, 'Especialista en desarrollo de software de gestión empresarial y soluciones en la nube.', NULL),
('31313131-1', 'Trabajador Veintisiete', 'trabajador27@example.com', 'gasfiter', '20000.00', 'contraseña27', NULL, NULL, 'Amplia experiencia en instalaciones de sistemas de fontanería para complejos residenciales.', NULL),
('32323232-2', 'Trabajador Veintiocho', 'trabajador28@example.com', 'carpintero', '18000.00', 'contraseña28', NULL, NULL, 'Experto en diseño y fabricación de muebles modernos y funcionales.', NULL),
('33333333-3', 'Trabajador Veintinueve', 'trabajador29@example.com', 'mecanico', '17500.00', 'contraseña29', NULL, NULL, 'Especialista en reparaciones de motores de barcos y embarcaciones marinas.', NULL),
('34343434-4', 'Trabajador Treinta', 'trabajador30@example.com', 'informatico', '18000.00', 'contraseña30', NULL, NULL, 'Amplia experiencia en desarrollo de aplicaciones móviles y soluciones de comercio electrónico.', NULL),
('43434343-4', 'Trabajador Uno', 'trabajador1@example.com', 'mecanico', '15000.00', 'contraseña1', '3.00', 3, 'Especialista en motores de automóviles y reparaciones generales.', NULL),
('54545454-5', 'Trabajador Dos', 'trabajador2@example.com', 'informatico', '18000.00', 'contraseña2', '4.20', NULL, 'Experto en desarrollo web y aplicaciones móviles.', NULL),
('65656565-6', 'Trabajador Tres', 'trabajador3@example.com', 'gasfiter', '20000.00', 'contraseña3', '4.80', NULL, 'Amplia experiencia en instalaciones de tuberías y sistemas de agua.', NULL),
('76767676-7', 'Trabajador Cuatro', 'trabajador4@example.com', 'carpintero', '16000.00', 'contraseña4', '4.30', NULL, 'Experto en diseño y fabricación de muebles de madera.', NULL),
('87878787-8', 'Trabajador Cinco', 'trabajador5@example.com', 'mecanico', '17000.00', 'contraseña5', '4.60', NULL, 'Especialista en reparaciones de vehículos comerciales.', NULL),
('98989898-9', 'Trabajador Seis', 'trabajador6@example.com', 'informatico', '19000.00', 'contraseña6', '4.40', NULL, 'Amplios conocimientos en redes y seguridad informática.', NULL);
